...
function Login(props) {
  ...
  function handleRegister() {
    const response = fetch("https://swiggy-backend-temp.onrender.com/api/register", {
      method: "POST",
      headers: {
  ...
  function handleLogin() {
       const response = fetch("https://swiggy-backend-temp.onrender.com/api/login", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
